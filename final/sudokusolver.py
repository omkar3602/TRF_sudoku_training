...
def call_solver(imgpath):
    ...
    # print(os.getcwd())
    puzzle = cv2.imread(os.path.join(os.getcwd(), imgpath))
    ...
    model = keras.models.load_model(os.path.join(os.getcwd(), 'digitRecognition.h5'))
    ...
    return unsolved_grid, grid.ravel().tolist()

a, b = call_solver('su.jpg')
